...
!!! ! Keep model state & working arrays resident on the accelerator
 !!! !$acc data copyin(oldstat%mem, newstat%mem, flux%mem, tend%mem, ref%density, ref%denstheta, ref%idens, ref%idenstheta, ref%pressure) create(dens,uwnd,wwnd,theta)
